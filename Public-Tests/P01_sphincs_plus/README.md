...
### Build Commands
To build one of the configurations:
```
cd 005_sphincs_PQCgenKAT_sign_blake_128f_simple
cmake -S ./ --preset test
cd build-ninja
cmake --build ./
```
The main executable is named `driver`.

## Associated Executable
For testing purposes, there is a provided executable whose main function can be found in [PQCgenKAT_sign.c](./005_sphincs_PQCgenKAT_sign_blake_128f_simple/project/app/src/PQCgenKAT_sign.c). 
